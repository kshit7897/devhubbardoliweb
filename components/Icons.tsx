...
export const QuoteIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M9.983 3v7.391c0 2.908-2.355 5.264-5.263 5.264s-5.264-2.356-5.264-5.264v-7.391h5.264v7.391c0 .033.024.06.053.06h.001c.023 0 .042-.018.042-.041v-7.41h5.167zm14.017 0v7.391c0 2.908-2.355 5.264-5.264 5.264s-5.264-2.356-5.264-5.264v-7.391h5.264v7.391c0 .033.024.06.053.06h.001c.023 0 .042-.018.042-.041v-7.41h5.168z" />
    </svg>
);
...
export const TargetIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m3 -10.5a9 9 0 11-18 0 9 9 0 0118 0z" />
